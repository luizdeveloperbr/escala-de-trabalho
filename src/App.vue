<template>
  <div class="wrap">
    <nav
      class="navbar is-dark prnt"
      role="navigation"
      aria-label="main navigation"
    >
      <div class="navbar-brand ml-2">
        <router-link class="navbar-item" to="/"
          ><span class="icon"><i class="fa fa-2x fa-home"></i></span
        ></router-link>
      </div>
      <div class="navbar-end mr-2 my-auto">
        <router-link
          class="
            navbar-item
            has-background-white has-text-black has-text-weight-light
            my-1
          "
          :to="{
            name: 'Organico',
    ...
    <router-view></router-view>
      <div class="content has-text-centered">
        <a href="https://github.com/luizdeveloperbr/vue-neutrino" target="_blank" id="github"> 
          Github Repo
        </a>
      </div>
  </div>
